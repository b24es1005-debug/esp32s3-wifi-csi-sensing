...
<p align="center">
  <img src="docs/images/banner_placeholder.png" alt="Project banner placeholder" style="max-width:100%;height:auto;" />
</p>

<p align="center">
  <img alt="Platform" src="https://img.shields.io/badge/Platform-ESP32--S3-00979D?logo=espressif&logoColor=white" />
  <img alt="Domain" src="https://img.shields.io/badge/Domain-WiFi%20CSI%20Sensing-2E86DE" />
  <img alt="ML" src="https://img.shields.io/badge/ML-Human%20Activity%20Recognition-8E44AD" />
  <img alt="Status" src="https://img.shields.io/badge/Status-Research%20Prototype-27AE60" />
  <img alt="License" src="https://img.shields.io/badge/License-MIT-yellow.svg" />
</p>

A research-oriented **WiFi CSI Human Activity Recognition (HAR)** platform built around **ESP32-S3**, real-time CSI streaming, feature-based ML inference, and a live analytics dashboard. This repository is suitable for embedded-AI portfolios, RF sensing demonstrations, and research internship showcases.
...
A compact visualization of the end-to-end system (firmware → host → ML → dashboard):

```text
Human Motion -> WiFi Channel -> ESP32-S3 CSI Capture
    └─ UART stream → Host Python logger → Windowing → Feature extraction
        └─ Training (Random Forest) → Saved model → Realtime inference
            └─ Dashboard (PyQt + pyqtgraph) visualizes predictions & CSI waveform
```

Details: `docs/architecture/system_architecture.md`.
...
Place screenshots in `docs/images/` using the filenames below. Do not add large binaries to the repo; prefer compressed PNG/JPEGs under 1–2 MB.

| View | Placeholder Path |
|---|---|
| Dashboard | `docs/images/dashboard_placeholder.png` |
| CSI Heatmap | `docs/images/heatmap_placeholder.png` |
| Activity Prediction | `docs/images/activity_prediction_placeholder.png` |
...
Play the demo video locally (GitHub may not autoplay local MP4 files). If your browser supports HTML5 video, the player below will attempt to play `docs/videos/demo.mp4`.

<p align="center">
  <video controls width="800" src="docs/videos/demo.mp4">
    Your browser does not support the video tag. Download: <a href="docs/videos/demo.mp4">demo.mp4</a>
  </video>
</p>

If you do not have a demo video yet, add `docs/videos/demo.mp4` or replace with a hosted URL.
...
<p align="center">
  <img src="docs/images/banner_placeholder.png" alt="Project banner placeholder" width="100%" />
</p>
